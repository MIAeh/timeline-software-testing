...
public class PoatTest16 {
  ...
  @Test
  public void testPoatTest16() throws Exception {
    ...
    driver.findElement(By.id("edit-area")).click();
    driver.findElement(By.id("edit-area")).clear();
    driver.findElement(By.id("edit-area")).sendKeys("abcdefghijklmnopqrstuvwxyz12345678901234567890测试测试测试。");
    driver.findElement(By.id("bt-upload-img")).click();
    driver.findElement(By.id("bt-upload-img")).clear();
    driver.findElement(By.id("bt-upload-img")).sendKeys("C:\\fakepath\\Test7.jpeg");
    driver.findElement(By.id("bt-post-new-msg")).click();
    assertEquals(closeAlertAndGetItsText(), "发布成功~");
  }
