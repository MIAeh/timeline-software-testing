...
public class 11A {
  ...
  public void test11A() throws Exception {
    ...
    driver.findElement(By.id("login-username")).sendKeys("htx");
    driver.findElement(By.id("login-pwd")).click();
    driver.findElement(By.id("login-pwd")).clear();
    driver.findElement(By.id("login-pwd")).sendKeys("123456h");
    driver.findElement(By.id("bt-login")).click();
    assertEquals("登陆成功", closeAlertAndGetItsText());
  }
